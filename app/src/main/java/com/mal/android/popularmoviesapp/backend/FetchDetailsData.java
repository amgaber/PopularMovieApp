...
public class FetchDetailsData extends AsyncTask<Uri.Builder, Void, String> {
    ...
    private final Integer detailDataId;
    ...
    public FetchDetailsData(AsyncTaskListener activityContext, Integer detailDataId, String detailsType) {
        this.asyncTaskListener = activityContext;
        this.detailsType=detailsType;
        //In case of reviews & trailers in Details screen
    ...
    protected String doInBackground(Uri.Builder... builders) {
        ...
        try {
            ...
            url = new URL(builder.toString());
             ...
             urIBuilder = builder.build().toString();
...
//        dialog.dismiss();
        if (detailsType.equals(DetailsActivityFragment.DETAILS_VIDEOS)){
            asyncTaskListener.notifyUpdateVidoes(s);
        }else if (detailsType.equals(DetailsActivityFragment.DETAILS_REVIEWS)){
            asyncTaskListener.notifyUpdateReviews(s);
        }
